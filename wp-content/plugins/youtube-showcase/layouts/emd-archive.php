...
$container = apply_filters('emd_change_container','emd-wrapper','youtube_showcase', 'archive');  
$has_sidebar = apply_filters( 'emd_show_temp_sidebar', 'right', 'youtube_showcase', 'archive');
?>
<div id="emd-temp-archive-container" class="emd-container emd-wrap <?php echo $has_sidebar; ?>">
<div class="<?php echo $container; ?>">
<div id="emd-primary" class="emd-site-content emd-row">
<?php 
	if($has_sidebar ==  'left'){
		do_action( 'emd_sidebar', 'youtube-showcase' );
	}
	if($has_sidebar == 'full'){
?>
...
<?php
	...
	while ( have_posts() ) : the_post(); ?>
			...
			<?php emd_get_template_part('youtube-showcase', 'archive', str_replace("_","-",$post->post_type)); ?>
			</div>
...
?>
<?php	$has_navigation = apply_filters( 'emd_show_temp_navigation', true, 'youtube_showcase', 'archive');
	if($has_navigation){
		global $wp_query;
